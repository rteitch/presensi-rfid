    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 border-b border-slate-200 pb-2 overflow-x-auto">
            <a href="{{ route('students.index') }}"
               class="px-4 py-2.5 rounded-xl text-xs font-extrabold transition flex items-center gap-2 shrink-0 bg-indigo-600 text-white shadow-sm">
            ...
            <a href="{{ route('students.trashed') }}"
               class="px-4 py-2.5 rounded-xl text-xs font-bold transition flex items-center gap-2 shrink-0 bg-slate-100 text-slate-600 hover:bg-slate-200">
                ...
                @if(!empty($trashedCount) && $trashedCount > 0)
                    <span class="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-rose-100 text-rose-700 border border-rose-200">{{ $trashedCount }}</span>
                @endif
            </a>
        </div>
        @endrole
