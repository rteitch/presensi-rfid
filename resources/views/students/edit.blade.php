                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-4 mt-2">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin', $student->jenis_kelamin) == 'L' ? 'checked' : '' }} class="text-indigo-600 focus:ring-indigo-500">
                                        <span class="text-sm font-semibold text-slate-700">Laki-laki</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin', $student->jenis_kelamin) == 'P' ? 'checked' : '' }} class="text-indigo-600 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <select name="agama" class="form-input">
                                    ...
                                    @foreach(['Islam','Kristen','Katolik','Hindu','Buddha','Konghucu'] as $ag)
                                        <option value="{{ $ag }}" {{ old('agama', $student->agama) == $ag ? 'selected' : '' }}>{{ $ag }}</option>
                                    @endforeach
                                </select>
