<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Tambah Device RFID Baru</h1>
                <p class="text-sm text-slate-500 mt-0.5">Daftarkan device scanner baru untuk autentikasi presensi.</p>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_device" value="{{ old('nama_device') }}" required class="form-input" placeholder="cth. Kiosk Gerbang Utama">
                        ...
                        <div>
                            ...
                            <select name="tipe_device" class="form-input font-medium" required>
                                <option value="kiosk" {{ old('tipe_device', 'kiosk') === 'kiosk' ? 'selected' : '' }}>🖥️ Mode 1: Kiosk Browser (Komputer/Laptop + Reader USB HID)</option>
                                <option value="microcontroller" {{ old('tipe_device') === 'microcontroller' ? 'selected' : '' }}>🔌 Mode 2: Microcontroller IoT Box (ESP32 / NodeMCU + MFRC522)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="lokasi" value="{{ old('lokasi') }}" class="form-input" placeholder="cth. Gerbang Depan, Lobby Utama">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-indigo-50/60 border border-indigo-100 rounded-xl space-y-2">
                            ...
                            <div class="flex gap-2 pt-1">
                                <input type="text" name="token_device" value="{{ old('token_device', $token) }}" required class="form-input font-mono flex-1 text-slate-900 font-bold">
