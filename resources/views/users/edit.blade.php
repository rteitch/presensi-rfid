<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Edit Pengguna: {{ $user->name }}</h1>
                <p class="text-xs text-slate-500 mt-0.5">Perbarui informasi akun, role, atau ganti password.</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="page-card p-6">
            <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $user->email) }}" class="form-input font-mono" required>
                ...
                <div class="pt-3 border-t border-slate-100 space-y-4">
                    <div>
                        ...
                        <p class="text-xs text-slate-400">Kosongkan kolom password di bawah ini jika tidak ingin mengubah password.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation" placeholder="Ketik ulang password baru" class="form-input">
                        </div>
                    </div>
                </div>
