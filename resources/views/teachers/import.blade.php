<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Import Data Guru / Dosen</h1>
                <p class="text-sm text-slate-500 mt-0.5">Upload file Excel (.xlsx/.xls/.csv) untuk import data guru secara massal.</p>
            </div>
    ...
    <div class="max-w-2xl space-y-4">
        ...
        <div class="page-card p-6">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <h3 class="font-bold text-slate-900">Panduan Format Import Guru</h3>
                    <p class="text-xs text-slate-500">Pastikan file sesuai format agar data guru berhasil diimport.</p>
                </div>
            </div>
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-lg p-4 space-y-3">
                <table class="w-full text-xs">
                    ...
                    <tbody class="text-slate-600">
                        <tr class="border-b border-slate-100">
                            <td class="py-1.5 font-mono font-bold">nip</td>
                            <td class="py-1.5">Nomor Induk Pegawai (Unik)</td>
                            <td class="py-1.5"><span class="badge badge-red text-[10px]">Wajib</span></td>
                        </tr>
                        <tr class="border-b border-slate-100">
                            <td class="py-1.5 font-mono font-bold">nama</td>
                            <td class="py-1.5">Nama lengkap guru</td>
                            <td class="py-1.5"><span class="badge badge-red text-[10px]">Wajib</span></td>
                        </tr>
                        <tr class="border-b border-slate-100">
                            <td class="py-1.5 font-mono font-bold">email</td>
                            <td class="py-1.5">Email login guru (opsional, auto-create akun)</td>
                            <td class="py-1.5"><span class="badge badge-gray text-[10px]">Opsional</span></td>
                        </tr>
                        <tr class="border-b border-slate-100">
                            <td class="py-1.5 font-mono font-bold">no_hp</td>
                            <td class="py-1.5">Nomor HP/WhatsApp</td>
                            <td class="py-1.5"><span class="badge badge-gray text-[10px]">Opsional</span></td>
                        </tr>
                        <tr class="border-b border-slate-100">
                            <td class="py-1.5 font-mono font-bold">mata_pelajaran</td>
                            <td class="py-1.5">Mata pelajaran yang diampu</td>
                            <td class="py-1.5"><span class="badge badge-gray text-[10px]">Opsional</span></td>
                        </tr>
                        <tr>
                ...
                <div class="flex items-center gap-2 pt-2 border-t border-slate-200">
                    ...
                    <span class="text-xs text-slate-500">Jika NIP sudah ada, data guru akan diupdate. Jika email diisi, akun login akan dibuatkan otomatis.</span>
                </div>
            </div>

            <div class="mt-4">
                <a href="{{ route('teachers.template') }}" class="btn-secondary text-emerald-700 border-emerald-200 bg-emerald-50 hover:bg-emerald-100">
        ...
        <!-- Form Upload -->
        <div class="page-card p-6">
            <form method="POST" action="{{ route('teachers.import-store') }}" enctype="multipart/form-data" class="space-y-4">
                @csrf
